...
@section('content')
            ...
            <div class="row gx-4 gx-lg-5 justify-content-center">
                <div class="col-lg-8 text-center">
                    ...
                    <p class="text-white mb-4 fs-5">
                        ...
                        distribution lines, the operation and management of water supply facilities, and the treatment of
                        sewage. We are the only water provider here in the municipality, thus we remain committed to serving
                        Bacuaganons with the utmost care and concern for the environment.
                    </p>
                </div>
            </div>
        </div>
    ...
    <!-- Vision -->
    <section class="page-section bg-dark" id="vision">
        <div class="container px-4 px-lg-5">
            <div class="row gx-4 gx-lg-5 justify-content-center">
                <div class="col-lg-8 text-center">
